...
/**************** MTI FUNCTIONS **************************/
_EXTERN S16BIT _DECL _rtmtiSetDefaultConfig(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceRTMTIStop(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceRTMTIStart(S16BIT DevNum);
