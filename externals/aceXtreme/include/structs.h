...
{
    U32 u32OpCode;       /* OpCode (XEQ, XET, XQF, or XQT) */
    U32 u32MsgAddr;      /* Message Address */
    U16 u16MsgID;        /* Message ID */
    U32 u32SlotStart;    /* Starting Slot Location */
    U32 u32SlotInterval; /* Repeat Interval (Slots) */
    U32 u32UseCount;     /* Use counter */
    struct DLISTNODE *pMemNode; /* Pointer to memory node */
...
typedef struct STREAMITEM
{
    ...
    U16    u16SubAddrCount;        /* RT Address 1 Sub Addresses */
    U16    u16RTAddr1;             /* RT Address 1 */
    U16    u16RTAddr2;             /* RT Address 2 */
    U16    u16MsgTime;             /* Execution Time Of Message In Microseconds */
    U32    u32SubAddrMask1;        /* RT Address 1 Sub Address Mask */
    U32    u32SubAddrMask2;        /* RT Address 2 Sub Address Mask */
    U32    u32MsgBaseAddr;         /* Base Address of Message Memory Block */
    U32    u32DataBaseAddr;        /* Base Address of Data Memory Block */
    U32    *u32CtrlBlockArray;     /* 30 RT-RT Message Control Block Array (30 Blocks * 16 Dwords = 480 Dwords) */
    struct DLISTNODE *pMemNode;    /* pointer to memory node */
...
{
    U16    u16RTAddr;              /* RT Address */
    U16    u16RTSubAddr;           /* RT Sub Address */
    U16    u16Transfer;            /* Type of Array Transfer (0 = Continuous, 1 = Single) */
    U16    u16MsgIndex;            /* Index of Next Message */
    U16    u16WordIndex;           /* Index of Next Buffer Word */
    U16    u16DevWordCount;        /* Device Message Word Count */
    U16    u16BufWordCount;        /* User Buffer Word Count */
    U32    u32MsgBaseAddr;         /* Base Address of Message Memory Block */
    U32    u32DataBaseAddr;        /* Base Address of Data Memory Block */
    U32    *u32CtrlBlkArray;       /* Message Control Block Array (8 Dwords + 32 Data Blocks = 256 Dwords) */
    struct DLISTNODE *pMemNode;    /* pointer to memory node */
