...
_EXTERN S16BIT _DECL _aceGetDiscOut(S16BIT DevNum, S16BIT Discrete);
_EXTERN S16BIT _DECL _aceGetDiscDir(S16BIT DevNum, S16BIT Discrete);
_EXTERN S16BIT _DECL _aceGetDiscIn(S16BIT DevNum, S16BIT Discrete);
_EXTERN S16BIT _DECL _aceSetDiscOut(S16BIT DevNum, S16BIT Discrete, DISC_LEVEL Level);
_EXTERN S16BIT _DECL _aceSetDiscDir(S16BIT DevNum, S16BIT Discrete, DISC_DIR Direction);

/* these get/set all the bits at once. */
_EXTERN S16BIT _DECL _aceGetDiscAll(S16BIT DevNum, U16BIT *Directions, U16BIT *Levels);
_EXTERN S16BIT _DECL _aceSetDiscAll(S16BIT DevNum, U16BIT  Directions, U16BIT  Levels);
