...
_EXTERN S16 _DECL _acexMTIConfigure
(
   S16BIT      s16DevNum,
...
_EXTERN S16BIT _DECL _acexMTISetExternalClk(S16BIT s16DevNum, U16BIT u16TTRes, U16BIT u16ExtCtrl);
_EXTERN S16BIT _DECL _acexMTIStop(S16BIT s16DevNum);
_EXTERN S16BIT _DECL _acexMTIStart(S16BIT s16DevNum);
_EXTERN S16BIT _DECL _acexMTIInitiateHostIrq(S16BIT s16DevNum);
_EXTERN S16BIT _DECL _acexMTIInitialize(S16BIT s16DevNum);
_EXTERN S16BIT _DECL _acexMTIFree(S16BIT s16DevNum);
_EXTERN S16BIT _DECL _acexMTIGetCh10DataPkt(S16BIT s16DevNum, PMTI_CH10_DATA_PKT *ppCh10Pkt, S16BIT s16Timeout);
_EXTERN S16BIT _DECL _acexMTIFreeCh10DataPkt(S16BIT DevNum, PMTI_CH10_DATA_PKT *ppCh10Pkt);
_EXTERN S16BIT _DECL _acexMTIPause(S16 s16DevNum);
_EXTERN S16BIT _DECL _acexMTIContinue(S16 s16DevNum);
_EXTERN S16BIT _DECL _acexMTIGetCh10TimePkt(S16BIT s16DevNum, PMTI_CH10_TIME_PKT *ppCh10Pkt, S16BIT Timeout);
_EXTERN S16BIT _DECL _acexMTIFreeCh10TimePkt(S16BIT s16DevNum, PMTI_CH10_TIME_PKT *ppCh10Pkt);
_EXTERN S16BIT _DECL _acexMTICh10TimeFmt(S16BIT s16DevNum, U16BIT u16Format);
_EXTERN S16BIT _DECL _acexMTICh10TimePktEnable(S16BIT s16DevNum, BOOLEAN bEnable);
_EXTERN S16BIT _DECL _acexMTISetCh10TimeRange(S16BIT DevNum, ACE_MTI_IRIG_RANGE Range);
_EXTERN S16BIT _DECL _acexMTIGetCh10TimeRange(S16BIT DevNum, ACE_MTI_IRIG_RANGE *pRange);
_EXTERN S16BIT _DECL _acexMTISetCh10TimePktId(S16BIT DevNum, U16BIT u16ChannelId);

_EXTERN S16 _DECL _acexMtiShow(S16 DevNum);

_EXTERN S16BIT _DECL _acexMTISetRespTimeout(S16BIT s16DevNum, U32BIT u32Multiple);
