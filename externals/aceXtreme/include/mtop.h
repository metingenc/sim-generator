...
_EXTERN S16BIT _DECL _aceMTGetInfo(S16BIT DevNum,MTINFO *pInfo);

/* This function allows the MT to be reconfigured to the users liking */
_EXTERN S16BIT _DECL _aceMTConfigure(S16BIT DevNum,
                                    U16BIT wMTStkType,
                                    U16BIT wCmdStkSize,
                                    U16BIT wDataStkSize,
                                    U32BIT dwOptions);
...
_EXTERN S16BIT _DECL _aceMTInstallHBuf(S16BIT DevNum,U32BIT dwHBufSize);
_EXTERN S16BIT _DECL _aceMTUninstallHBuf(S16BIT DevNum);

/* These functions are used to enable/disable MT sel. msg monitoring */
_EXTERN S16BIT _DECL _aceMTEnableRTFilter(S16BIT DevNum,
                                         U16BIT wRT,
                                         U16BIT wTR,
                                         U32BIT dwSAMask);
_EXTERN S16BIT _DECL _aceMTDisableRTFilter(S16BIT DevNum,
                                          U16BIT wRT,
                                          U16BIT wTR,
                                          U32BIT dwSAMask);
_EXTERN S16BIT _DECL _aceMTGetRTFilter(S16BIT DevNum,
                                      U16BIT wRT,
                                      U16BIT wTR,
                                      U32BIT *pSAMask);

/* MT Run functions */
_EXTERN S16BIT _DECL _aceMTStart(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTStop(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTPause(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTContinue(S16BIT DevNum);

/* Onboard Stk functions */
_EXTERN S16BIT _DECL _aceMTGetStkMsgsRaw(S16BIT DevNum,
                                        U16BIT *pBuffer,
                                        U16BIT wBufferSize,
                                        U16BIT wStkLoc);
_EXTERN S16BIT _DECL _aceMTGetStkMsgDecoded(S16BIT DevNum,
                                           MSGSTRUCT *pMsg,
                                           U16BIT wMsgLoc,
                                           U16BIT wStkLoc);

/* Host buffer functions */
_EXTERN S16BIT _DECL _aceMTGetHBufMsgsRaw(S16BIT DevNum,
                                         U16BIT *pBuffer,
                                         U16BIT wBufferSize,
                                         U32BIT *pdwMsgCount,
                                         U32BIT *pdwMsgLostStk,
                                         U32BIT *pdwMsgLostHBuf);
_EXTERN S16BIT _DECL _aceMTGetHBufMsgDecoded(S16BIT DevNum,
                                            MSGSTRUCT *pMsg,
                                            U32BIT *pdwMsgCount,
                                            U32BIT *pdwMsgLostStk,
                                            U32BIT *pdwMsgLostHBuf,
...
_EXTERN S16BIT _DECL _aceMTDecodeRawMsg(S16BIT DevNum,U16BIT *pBuffer,
                                       MSGSTRUCT *pMsg);
_EXTERN S16BIT _DECL _aceMTStkToHBuf(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTStkToHBuf32(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTGetHBufMsgCount(S16BIT DevNum);


_EXTERN S16BIT _DECL _aceMTClearHBufTrigger(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTSetHBufTrigger(S16BIT DevNum,
                                         U16BIT wHBufPercent,
                                         MTTRIGGER *pTrg);

_EXTERN S16BIT _DECL _aceMTISQRead(S16BIT DevNum, ISQENTRY *pISQEntry);

_EXTERN S16BIT _DECL _aceMTCreateImageFiles(S16BIT DevNum,
                                           char *pszIFile,
                                           char *pszHFile);

_EXTERN S16BIT _DECL _aceMTSwapStks(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceMTGetHBufMetric( S16BIT DevNum,
                                         HBUFMETRIC *pMetric,
                                         U16BIT bReset);

_EXTERN S16BIT _DECL _aceMTGetStkMetric( S16BIT DevNum,
                                        STKMETRIC *pMetric,
                                        U16BIT wStk,
                                        U16BIT bReset);
