 ...
 *
 *
 *  Msgop.h (Message structure operations header file)
 *
 *
 *
 *  Created 8/26/99 DL
...
_EXTERN S16BIT _DECL aceCmdWordCreate(U16BIT *pCmdWrd,
                                      U16BIT wRT,
                                      U16BIT wTR,
                                      U16BIT wSA,
                                      U16BIT wWC);

_EXTERN S16BIT _DECL aceCmdWordParse(U16BIT wCmdWrd,
                                     U16BIT *pRT,
                                     U16BIT *pTR,
                                     U16BIT *pSA,
                                     U16BIT *pWC);

_EXTERN char* _DECL aceGetMsgTypeString(U16BIT wMsgType);
_EXTERN char* _DECL aceGetBSWErrString(U16BIT wMode,U16BIT wBlkSts);
