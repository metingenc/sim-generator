...
#define MTI_INTERRUPT_MSG_MIN       100      /* Based On Min Buffer Size */
...
------------------------------------------------------------------------*/
#if defined (WIN32) || defined (VX_WORKS)
#pragma pack(1)
#endif /* (WIN32) || (VX_WORKS) */
...
/**************** MTI FUNCTIONS **************************/
_EXTERN S16BIT _DECL _mtiSetDefaultConfig(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTISetExternalClk(S16BIT DevNum, U16BIT wTTRes, U16BIT wExtCtrl);
_EXTERN S16BIT _DECL _aceMTIStop(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTIPause(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTIContinue(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTIStart(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceMTIInitiateHostIrq(S16BIT DevNum);
...
_EXTERN S16BIT _DECL _aceMTIGetCh10DataPkt(S16BIT DevNum, PMTI_CH10_DATA_PKT *ppCh10Pkt, S16BIT Timeout);
_EXTERN S16BIT _DECL _aceMTIFreeCh10DataPkt(S16BIT DevNum, PMTI_CH10_DATA_PKT *ppCh10Pkt);
_EXTERN S16BIT _DECL _aceMTIGetCh10TimePkt(S16BIT DevNum, PMTI_CH10_TIME_PKT *ppCh10Pkt, S16BIT Timeout);
_EXTERN S16BIT _DECL _aceMTIFreeCh10TimePkt(S16BIT DevNum, PMTI_CH10_TIME_PKT *ppCh10Pkt);
_EXTERN S16BIT _DECL _aceMTICh10TimeFmt(S16BIT DevNum, U16BIT Format);
_EXTERN S16BIT _DECL _aceMTICh10TimePktEnable(S16BIT DevNum, BOOLEAN bEnable);
_EXTERN S16BIT _DECL _aceMTIDecodeRawMsg(PMTI_CH10_DATA_PKT pCh10Pkt, U16BIT **ppCurMsg, MSGSTRUCT *pDecMsg);
_EXTERN S16BIT _DECL _aceMTISetCh10TimePktId(S16BIT DevNum, U16BIT u16ChannelId);
