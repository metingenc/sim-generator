...
* Module Description:
*
* The purpose of this module is to define internally shared functions and definitions.
* Functions and definitions specified here are either internally global or shared
...
#define MT_FREE_MEM_COUNT_THRESHOLD                 0x0057
...
#define ACEX_MTI_IO_TIMEOUT_PENDING_STATUS       MAKE_STATUS(STATUS_SEVERITY_ERROR,FACILITY_IO_ERROR_CODE,ACEX_MTI_IO_TIMEOUT_PENDING_VALUE)
...
/* ========================================================================== */
S16BIT _DECL _coSetInternalIsr(S16BIT DevNum, U16BIT(_DECL *funcInternalIsr)(S16BIT DevNum, U32BIT dwIrqStatus));
S16BIT _DECL _coSetInternalImr(S16BIT DevNum, U16BIT bEnable, U32BIT dwIMR);
S16BIT _DECL _coSetExternalImr(S16BIT DevNum, U16BIT bEnable, U32BIT dwIMR);
S16BIT _DECL _coSetIrqConfig( S16BIT DevNum, U16BIT wLvlOrPulse, U16BIT wAutoClear);
U16BIT _DECL _coBCInternalIsr(S16BIT DevNum, U32BIT dwIrqStatus);
U16BIT _DECL _coMTInternalIsr(S16BIT DevNum, U32BIT dwIrqStatus);
U16BIT _DECL _coRTInternalIsr(S16BIT DevNum, U32BIT dwIrqStatus);
U16BIT _DECL _coRTMTInternalIsr(S16BIT DevNum, U32BIT dwIrqStatus);
U16BIT _DECL _coMRTInternalIsr(S16BIT DevNum, U32BIT dwIrqStatus);
U16BIT _DECL _coDetermineMiniAceDevice(S16BIT DevNum);

/* ========================================================================== */
/*                   EMACE BC INTERNAL FUNCTION PROTOTYPES                    */
/* ========================================================================== */
S16BIT _DECL _bcSetDefaultConfig(S16BIT DevNum);
S16BIT _DECL _bcSetGPFState( S16BIT DevNum,U16BIT wGPF,U16BIT wStateChange);

/* ========================================================================== */
/*                   EMACE MT INTERNAL FUNCTION PROTOTYPES                    */
/* ========================================================================== */
S16BIT _DECL _mtSetDefaultConfig(S16BIT DevNum);
S16BIT _DECL _mtLockStackPtr(S16BIT DevNum);
U16BIT _DECL _mtGetMsgAtAddr(S16BIT DevNum,U32BIT dwCmdStkAddr, MTSTACK *pStk, U16BIT *pBuffer, U16BIT bPurge);
U16BIT _DECL _mtGetMsgAtAddr32(S16BIT DevNum,U32BIT dwCmdStkAddr, MTSTACK *pStk, U32BIT *pBuffer, U16BIT bPurge);
U16BIT _DECL _mtCheckForTrigger(S16BIT DevNum,U16BIT *pBuffer);

/* ========================================================================== */
/*                 EMACE RT(MT) INTERNAL FUNCTION PROTOTYPES                  */
/* ========================================================================== */
S16BIT _DECL _rtSetDefaultConfig(S16BIT DevNum);
S16BIT _DECL _rtLockStackPtr(S16BIT DevNum);
S16BIT _DECL _rtmtSetDefaultConfig(S16BIT DevNum);
S16BIT _DECL _rtmtTmpMTStkToHBuf(S16BIT DevNum);
S16BIT _DECL _rtmtTmpMTStkToHBuf32(S16BIT DevNum);
S16BIT _DECL _rtmtMergeHBufs(S16BIT DevNum);

/* ========================================================================== */
/*                  EMACE TEST INTERNAL FUNCTION PROTOTYPES                   */
/* ========================================================================== */
S16BIT _DECL _tsSetDefaultConfig(S16BIT DevNum);
...
typedef struct _ACEXINFO
{
    ...
    ACEX_BOARD_TYPE sBdInfo; /* Global Board container */
    U32BIT          u32State;

    /* Padding as a temporary fix to protect local variables
       when this structure is being populated by 64 bit drivers. */
    U8BIT  u8Pad[256];
} ACEXINFO;
...
/* ========================================================================== */
S16BIT _DECL _bcxFree(S16BIT s16DevNum);
S16BIT _DECL _bcxDecodeRawMsg(S16BIT DevNum, U16BIT *pBuffer, MSGSTRUCT *pMsg);
...
/* ========================================================================== */
S16BIT _DECL _mtxSetDefaultConfig(S16BIT s16DevNum);
S16BIT _DECL _mtxDecodeRawMsg(U16BIT *pBuffer, MSGSTRUCT *pMsg);

/* ========================================================================== */
/*                   ACEX MRT INTERNAL FUNCTION PROTOTYPES                    */
/* ========================================================================== */
_EXTERN S16BIT _DECL _rtxFree(S16BIT DevNum);
_EXTERN S16BIT _DECL _rtxRTConfigure(S16BIT DevNum, U16BIT wCmdStkSize, U32BIT dwOptions);
_EXTERN S16BIT _DECL _rtxDataBlkCreate(S16BIT DevNum, S16BIT nDataBlkID, U16BIT u16DataBlkType, U16BIT *pBuffer, U16BIT u16BufferSize);
_EXTERN S16BIT _DECL _rtxDataBlkDelete(S16BIT DevNum, S16BIT nDataBlkID);
_EXTERN S16BIT _DECL _rtxDataBlkWrite(S16BIT DevNum, S16BIT nDataBlkID, U16BIT *pBuffer, U16BIT u16BufferSize, U16BIT u16Offset);
_EXTERN S16BIT _DECL _rtxDataBlkRead(S16BIT DevNum, S16BIT nDataBlkID, U16BIT *pBuffer, U16BIT u16BufferSize, U16BIT u16Offset);
_EXTERN S16BIT _DECL _rtxInstallHBuf(S16BIT DevNum, U32BIT dwHBufSize);
_EXTERN S16BIT _DECL _rtxGetHBufMsgDecoded(S16BIT DevNum, MSGSTRUCT *pMsg, U32BIT *pdwMsgCount, U32BIT *pdwMsgLostStk, U32BIT *pdwMsgLostHBuf, U16BIT wMsgLoc);
_EXTERN S16BIT _DECL _rtxGetHBufMsgsRaw(S16BIT DevNum, U16BIT *pBuffer, U16BIT wBufferSize, U32BIT *pdwMsgCount, U32BIT *pdwMsgLostStk, U32BIT *pdwMsgLostHBuf);
_EXTERN S16BIT _DECL _rtxGetHBufMetric(S16BIT DevNum, HBUFMETRIC *pMetric, U16BIT bReset);
_EXTERN S16BIT _DECL _rtxGetHBufMsgCount(S16BIT DevNum);
_EXTERN S16BIT _DECL _rtxUninstallHBuf(S16BIT DevNum);
_EXTERN S16BIT _DECL _rtxStkToHBuf32(S16BIT DevNum);
_EXTERN S16BIT _DECL _rtxDecodeRawMsg(S16BIT DevNum, U16BIT *pBuffer, MSGSTRUCT *pMsg);
_EXTERN S16BIT _DECL _rtxAcquireAddress(S16BIT DevNum, U16BIT *wRTAddr, U16BIT wCANBus);
_EXTERN S16BIT _DECL _rtxGetAddress(S16BIT DevNum, U16BIT *pRTAddress);
_EXTERN S16BIT _DECL _rtxGetAddrSource(S16BIT DevNum, U16BIT *wRTSource);
_EXTERN S16BIT _DECL _rtxRelatchAddr(S16BIT DevNum);
_EXTERN S16BIT _DECL _rtxSetAddress(S16BIT DevNum, U16BIT wRTAddress);
_EXTERN S16BIT _DECL _rtxSetAddrSource(S16BIT DevNum, U16BIT wRTSource);
_EXTERN S16BIT _DECL _rtxSetDefaultConfig(S16BIT DevNum, U8BIT u8UseSRTCmdStkSize);
_EXTERN S16BIT _DECL _rtxGetStkMetric(S16BIT DevNum, STKMETRIC *pMetric, U16BIT bReset);
_EXTERN S16BIT _DECL _rtxDataBlkCircBufInfo(S16BIT DevNum, S16BIT nDataBlkID, U16BIT *pUserRWOffset, U16BIT *pAceRWOffset);
_EXTERN S16BIT _DECL _rtxGetStkMsgsRaw(S16BIT DevNum, U16BIT *pBuffer, U16BIT wBufferSize);
_EXTERN S16BIT _DECL _rtxGetStkMsgDecoded(S16BIT DevNum, MSGSTRUCT *pMsg, U16BIT wMsgLoc);
_EXTERN S16BIT _DECL _rtxStrMemAlloc(S16 DevNum, S16 *pDBlkID, U32 *pu32DwdPtr, U32 u32BufWdSize, U8 bAlloc);
_EXTERN S16BIT _DECL _rtxStrDBlkMapToRTSA(S16 DevNum, ACEX_MRT_STREAM_TYPE *pMrtStream, U16 u16MsgType, U16 wIrqOptions, U16 wLegalizeSA);
_EXTERN S16BIT _DECL _rtxDataStreamReset(S16 s16DevNum, S8 s8RTAddr, U8 u8Direction);
_EXTERN void   _DECL _rtxShow(S16BIT DevNum);
_EXTERN void   _DECL _rtxIsqShow(S16BIT DevNum);

_EXTERN S16BIT _DECL _acexRTInitialize(S16BIT s16DevNum);
_EXTERN S16BIT _DECL _acexMRTInitialize(S16BIT s16DevNum);

_EXTERN S16BIT _DECL acexMRTInitialize(S16BIT s16DevNum);
_EXTERN S16BIT _DECL acexMRTFree(S16BIT s16DevNum );

void _rtxDisplayStkMetric(S16BIT DevNum);
void _rtxClearISQ(S16BIT DevNum);
