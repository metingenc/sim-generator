...
#define ACE_RT_OPTIONS_MAX              0x80000000
...
/**************** RT FUNCTIONS **************************/
_EXTERN S16BIT _DECL _aceRTConfigure(S16BIT DevNum,U16BIT wCmdStkSize,
                                    U32BIT wOptions);

_EXTERN S16BIT _DECL _aceRTSetAddress(S16BIT DevNum,U16BIT wRTAddress);

_EXTERN S16BIT _DECL _aceRTGetAddress(S16BIT DevNum,U16BIT *pRTAddress);

_EXTERN S16BIT _DECL _aceRTDataBlkCircBufInfo(S16BIT DevNum,
                                             S16BIT nDataBlkID,
                                             U16BIT *pUserRWOffset,
                                             U16BIT *pAceRWOffset);

_EXTERN S16BIT _DECL _aceRTDataBlkCreate(S16BIT DevNum,
                                        S16BIT nDataBlkID,
                                        U16BIT wDataBlkType,
                                        U16BIT *pBuffer,
                                        U16BIT wBufferSize);

_EXTERN S16BIT _DECL _aceRTDataBlkDelete(S16BIT DevNum,
                                        S16BIT nDataBlkID);

_EXTERN S16BIT _DECL _aceRTDataBlkWrite(S16BIT DevNum,
                                       S16BIT nDataBlkID,
                                       U16BIT *pBuffer,
                                       U16BIT wBufferSize,
                                       U16BIT wOffset);

_EXTERN S16BIT _DECL _aceRTDataBlkRead(S16BIT DevNum,
                                      S16BIT nDataBlkID,
                                      U16BIT *pBuffer,
                                      U16BIT wBufferSize,
                                      U16BIT wOffset);

_EXTERN S16BIT _DECL _aceRTDataBlkMapToSA(S16BIT DevNum,
                                         S16BIT nDataBlkID,
                                         U16BIT wSA,
                                         U16BIT wMsgType,
                                         U16BIT wIrqOptions,
...
_EXTERN S16BIT _DECL _aceRTDataBlkUnmapFromSA(S16BIT DevNum,
                                             S16BIT nDataBlkID,
                                             U16BIT wSA,
                                             U16BIT wMsgType);

_EXTERN S16BIT _DECL _aceRTModeCodeIrqEnable(S16BIT DevNum,
                                            U16BIT wModeCodeType,
                                            U16BIT wModeCodeIrq);

_EXTERN S16BIT _DECL _aceRTModeCodeIrqDisable(S16BIT DevNum,
                                             U16BIT wModeCodeType,
                                             U16BIT wModeCodeIrq);

_EXTERN S16BIT _DECL _aceRTModeCodeIrqStatus(S16BIT DevNum,
                                            U16BIT wModeCodeType,
                                            U16BIT *pwMCIrqStatus);

_EXTERN S16BIT _DECL _aceRTModeCodeReadData(S16BIT DevNum,
                                           U16BIT wModeCode,
                                           U16BIT *pMCData);

_EXTERN S16BIT _DECL _aceRTModeCodeWriteData(S16BIT DevNum,
                                            U16BIT wModeCode,
                                            U16BIT wMCData);

_EXTERN S16BIT _DECL _aceRTSetAddrSource(S16BIT DevNum,
                                        U16BIT wRTSource);

_EXTERN S16BIT _DECL _aceRTGetAddrSource(S16BIT DevNum,
                                        U16BIT *wRTSource);

_EXTERN S16BIT _DECL _aceRTMsgLegalityEnable(S16BIT DevNum,
...
_EXTERN S16BIT _DECL _aceRTMsgLegalityDisable(S16BIT DevNum,
                                             U16BIT wOwnAddrOrBcst,
                                             U16BIT wTR,
                                             U16BIT wSA,
                                             U32BIT dwWC_MCMask);
...
_EXTERN S16BIT _DECL _aceRTMsgLegalityStatus(S16BIT DevNum,
                                            U16BIT wOwnAddrOrBcst,
                                            U16BIT wTR,
                                            U16BIT wSA,
                                            U32BIT *pdwMsgLegality);

_EXTERN S16BIT _DECL _aceRTBusyBitsTblSet(S16BIT DevNum,
                                         U16BIT wOwnAddrOrBcst,
                                         U16BIT wTR,
                                         U32BIT dwSAMask);


_EXTERN S16BIT _DECL _aceRTBusyBitsTblClear(S16BIT DevNum,
                                           U16BIT wOwnAddrOrBcst,
                                           U16BIT wTR,
                                           U32BIT dwSAMask);

_EXTERN S16BIT _DECL _aceRTBusyBitsTblStatus(S16BIT DevNum,
                                            U16BIT wOwnAddrOrBcst,
                                            U16BIT wTR,
                                            U32BIT *pdwSABusyBits);

_EXTERN S16BIT _DECL _aceRTStatusBitsSet(S16BIT DevNum,
                                        U16BIT wStatusBits);

_EXTERN S16BIT _DECL _aceRTStatusBitsClear(S16BIT DevNum,
                                          U16BIT wStatusBits);

_EXTERN S16BIT _DECL _aceRTStatusBitsStatus(S16BIT DevNum,
                                           U16BIT *pwStatusBits);


_EXTERN S16BIT _DECL _aceRTBITWrdConfig(S16BIT DevNum,U16BIT wBITLoc,
                                       U16BIT wBITBusyInh);

_EXTERN S16BIT _DECL _aceRTBITWrdRead(S16BIT DevNum,U16BIT wBITLoc,
                                     U16BIT *pBITWrd);

_EXTERN S16BIT _DECL _aceRTBITWrdWrite(S16BIT DevNum,U16BIT wBITWrd);


_EXTERN S16BIT _DECL _aceRTStart(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceRTStop(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceRTGetStkMsgsRaw(S16BIT DevNum,
                                        U16BIT *pBuffer,
                                        U16BIT wBufferSize);

_EXTERN S16BIT _DECL _aceRTDecodeRawMsg(S16BIT DevNum,U16BIT *pBuffer,
                                       MSGSTRUCT *pMsg);

_EXTERN S16BIT _DECL _aceRTGetStkMsgDecoded(S16BIT DevNum,
                                           MSGSTRUCT *pMsg,
                                           U16BIT wMsgLoc);

_EXTERN S16BIT _DECL _aceRTInstallHBuf(S16BIT DevNum,
                                      U32BIT dwHBufSize);

_EXTERN S16BIT _DECL _aceRTUninstallHBuf(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceRTStkToHBuf(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceRTStkToHBuf32(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceRTGetHBufMsgCount(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceRTGetHBufMsgsRaw(S16BIT DevNum,
                                         U16BIT *pBuffer,
                                         U16BIT wBufferSize,
                                         U32BIT *pdwMsgCount,
...
_EXTERN S16BIT _DECL _aceRTGetHBufMsgDecoded(S16BIT DevNum,
                                            MSGSTRUCT *pMsg,
                                            U32BIT *pdwMsgCount,
                                            U32BIT *pdwMsgLostStk,
                                            U32BIT *pdwMsgLostHBuf,
...
_EXTERN S16BIT _DECL _aceRTCreateImageFiles(S16BIT DevNum,
                                           char *pszIFile,
                                           char *pszHFile);

_EXTERN S16BIT _DECL _aceRTGetHBufMetric( S16BIT DevNum,
                                         HBUFMETRIC *pMetric,
                                         U16BIT bReset);

_EXTERN S16BIT _DECL _aceRTGetStkMetric( S16BIT DevNum,
                                        STKMETRIC *pMetric,
                                        U16BIT bReset);

_EXTERN S16BIT _DECL _aceRTRelatchAddr(S16BIT DevNum);
