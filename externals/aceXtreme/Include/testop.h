...
_EXTERN S16BIT _DECL PrintError(U32BIT ErrorCode);
...
_EXTERN S16BIT _DECL _aceTestConfigure(S16BIT DevNum,U32BIT dwOptions);

_EXTERN S16BIT _DECL _aceTestRegisters(S16BIT DevNum,TESTRESULT *pTest);

_EXTERN S16BIT _DECL _aceTestMemory(S16BIT DevNum,TESTRESULT *pTest,
                                   U16BIT wValue);

_EXTERN S16BIT _DECL _aceTestProtocol(S16BIT DevNum,TESTRESULT *pTest);

_EXTERN S16BIT _DECL _aceTestIrqs(S16BIT DevNum,TESTRESULT *pTest);

_EXTERN S16BIT _DECL _aceTestVectors(S16BIT DevNum,TESTRESULT *pTest,
                                   char *pFileName);

_EXTERN S16BIT _DECL _aceTestVectorsStatic(S16BIT DevNum,TESTRESULT *pTest);


_EXTERN S16BIT _DECL _aceTestCanEbrLoop(S16BIT DevNum,
                                       TESTRESULT *pTest);

_EXTERN S32BIT _DECL _aceTestGetCardTypeFromDevID(S16BIT DevNum);

_EXTERN S16BIT _DECL _aceTestLoopBack(S16BIT DevNum, TESTRESULT *pTest);

_EXTERN S16BIT _DECL _flexTestVectors(S16BIT DevNum,TESTRESULT *pTest,
                                   char *pFileName);

_EXTERN S16BIT _DECL _aceTestLoopBackInt(S16BIT DevNum, TESTRESULT *pTest);

_EXTERN S16BIT _DECL _aceTestEBRLoopBack(S16BIT DevNum, TESTRESULT *pTest, U16BIT wHubNumTx, U16BIT wHubNumRx);
