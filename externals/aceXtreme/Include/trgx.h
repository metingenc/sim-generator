...
/* ========================================================================== */
_EXTERN S16BIT _DECL _acexTRGReset(S16BIT s16DevNum);

_EXTERN S16BIT _DECL _acexTRGConfigure(S16BIT s16DevNum, U16BIT u16TrgId, ACEX_TRG_CONFIG sTrgConfig);
_EXTERN S16BIT _DECL _acexTRGEnable(S16BIT s16DevNum, U16BIT u16TrgId);
_EXTERN S16BIT _DECL _acexTRGDisable(S16BIT s16DevNum, U16BIT u16TrgId);

_EXTERN S16BIT _DECL _acexTRGEventSelect(S16BIT s16DevNum, U16BIT u16TrgId, U16BIT u16Events, U16BIT u16EvtInput);
_EXTERN S16BIT _DECL _acexTRGEventEnable(S16BIT s16DevNum, U16BIT u16Events);
_EXTERN S16BIT _DECL _acexTRGEventDisable(S16BIT s16DevNum, U16BIT u16Events);

_EXTERN S16BIT _DECL _acexTRGGetTimeTag(S16BIT s16DevNum, U64BIT *pu64TimeTagValue);
_EXTERN S16BIT _DECL _acexTRGGetStatus(S16BIT s16DevNum, U32BIT *pu32TrgStatus, U32BIT *pu32IrqStatus);
