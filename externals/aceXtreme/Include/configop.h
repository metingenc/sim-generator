...
/*---------------------- FUNCTION PROTOYPES -------------------------*/
_EXTERN U16BIT _DECL _aceGetLibVersion(void);
_EXTERN U16BIT _DECL _aceGetCoreVersion(void);
_EXTERN S16BIT _DECL _aceGetSwVersionInfo(PSWVERSIONINFO pSwVersionInfo);
_EXTERN S16BIT _DECL _aceGetHwVersionInfo(S16BIT DevNum, PHWVERSIONINFO pHwVersionInfo);
_EXTERN S16BIT _DECL _aceInitialize(S16BIT DevNum, U16BIT wAccess, U16BIT wMode, U32BIT dwMemWrdSize, U32BIT dwRegAddr, U32BIT dwMemAddr);
_EXTERN S16BIT _DECL _aceFree(S16BIT DevNum);
_EXTERN U16BIT _DECL _aceRegRead(S16BIT DevNum, U16BIT wRegister);
_EXTERN S16BIT _DECL _aceRegWrite(S16BIT DevNum, U16BIT wRegAddr, U16BIT wValue);
_EXTERN U32BIT _DECL _aceRegRead32(S16BIT DevNum, U16BIT wRegister);
_EXTERN S16BIT _DECL _aceRegWrite32(S16BIT DevNum, U16BIT wRegAddr, U32BIT dwValue);
_EXTERN U16BIT _DECL _aceMemRead(S16BIT DevNum, U16BIT wMemAddr);
_EXTERN S16BIT _DECL _aceMemWrite(S16BIT DevNum, U16BIT wMemAddr, U16BIT wValue);
_EXTERN U32BIT _DECL _aceMemRead32(S16BIT DevNum, U32BIT dwMemAddr);
_EXTERN S16BIT _DECL _aceMemWrite32(S16BIT DevNum, U32BIT dwMemAddr, U32BIT dwValue);
_EXTERN S16BIT _DECL _aceSetTimeTagRes(S16BIT DevNum, U16BIT wTTRes);
_EXTERN S16BIT _DECL _aceSetTimeTagValue(S16BIT DevNum, U16BIT wTTValue);
_EXTERN S16BIT _DECL _aceGetTimeTagValue(S16BIT DevNum, U16BIT* wTTValue);
_EXTERN S16BIT _DECL _aceSetTimeTagValueEx(S16BIT DevNum, U64BIT ullTTValue);
_EXTERN S16BIT _DECL _aceGetTimeTagValueEx(S16BIT DevNum, U64BIT* ullTTValue);
_EXTERN S16BIT _DECL _aceResetTimeTag(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceSetRespTimeOut(S16BIT DevNum, U16BIT wRespTimeOut);
_EXTERN S16BIT _DECL _aceSetClockFreq(S16BIT DevNum, U16BIT wClockIn);
_EXTERN S16BIT _DECL _aceSetIrqConfig(S16BIT DevNum, U16BIT wLvlOrPulse, U16BIT wAutoClear);
_EXTERN S16BIT _DECL _aceSetDecoderConfig(S16BIT DevNum, U16BIT wDoubleOrSingle, U16BIT wExpXingEnable);
...
_EXTERN S16BIT _DECL _aceSetRamParityChecking(S16BIT DevNum, U16BIT wRamParityEnable);
_EXTERN S16BIT _DECL _aceISQRead(S16BIT DevNum, ISQENTRY *pISQEntry);
_EXTERN S16BIT _DECL _aceISQClear(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceISQEnable(S16BIT DevNum, U16BIT bEnable);
_EXTERN S16BIT _DECL _aceSetMetrics(S16BIT DevNum, U16BIT bEnable);
_EXTERN S16BIT _DECL _aceInt80Enable(S16BIT DevNum, U16BIT bEnable);
_EXTERN S16BIT _DECL _aceSetAsyncIsr(S16BIT DevNum, void(_DECL *funcAsyncIsr)(S16BIT DevNum, U16BIT wMnrFrmId));
_EXTERN S16BIT _DECL _aceSetAsyncIsr(S16BIT DevNum, void(_DECL *funcAsyncIsr)(S16BIT DevNum, U16BIT wMnrFrmId));
_EXTERN S16BIT _DECL _aceGetCardType(S16BIT DevNum, U32BIT *dwCardType);

/* these initialize the discrete and avionic functions independent of 1553. */
_EXTERN S16BIT _DECL _aceIOInitialize(S16BIT DevNum, S16BIT wOptions);
_EXTERN S16BIT _DECL _aceIOFree(S16BIT DevNum);
_EXTERN S16BIT _DECL _aceGetChannelCount(S16BIT DevNum, CHANCOUNT_t *pChanCount);
/* Digital IRIG Tramsmitter Definitions */

_EXTERN S16BIT _DECL _aceGetIRIGTx(S16BIT DevNum, PACE_IRIG_TX pstructIRIG);
_EXTERN S16BIT _DECL _aceSetIRIGTx(S16BIT DevNum, ACE_IRIG_TX structIRIG);

/* EBR Only */
_EXTERN S16BIT _DECL _aceSetHubAddress(S16BIT DevNum, U16BIT wHubNum);
