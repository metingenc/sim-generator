...
_EXTERN S16BIT _DECL _aceGetAioOut(S16BIT DevNum, S16BIT Channel);
_EXTERN S16BIT _DECL _aceSetAioDir(S16BIT DevNum, S16BIT Channel, AVIONIC_DIRECTION Direction);
_EXTERN S16BIT _DECL _aceGetAioDir(S16BIT DevNum, S16BIT Channel);
_EXTERN S16BIT _DECL _aceGetAioIn(S16BIT DevNum, S16BIT Channel);
_EXTERN S16BIT _DECL _aceSetAioOut(S16BIT DevNum, S16BIT Channel, AVIONIC_LEVEL Level);

/* these get/set all the bits at once. */
_EXTERN S16BIT _DECL _aceGetAioAll(S16BIT DevNum, U16BIT *Directions, U16BIT *Levels);
_EXTERN S16BIT _DECL _aceSetAioAll(S16BIT DevNum, U16BIT Directions, U16BIT Levels);
